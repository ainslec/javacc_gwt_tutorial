...
/** Token Manager. */
@SuppressWarnings("unused")public class Parser2TokenManager implements Parser2Constants {
...
"", null, "\146\157\165\162", "\146\151\166\145", "\163\151\170", };
...
private void jjCheckNAddTwoStates(int state1, int state2)
{
   ...
   jjCheckNAdd(state2);
    ...
    /** Constructor. */
    public Parser2TokenManager(JavaCharStream stream){
  ...
  /** Constructor. */
  public Parser2TokenManager (JavaCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
